...
Criado por Alex Ferreira Alves
aalves@bsabrasil.com.br
*********************************************/
...
namespace Intentor.Yamapper.Drivers {
    /// <summary>
    /// Driver para acesso ao Oracle, utilizando Oracle.DataAccess.Client (ODP.NET).
    /// </summary>
    /// <remarks>
    /// Parâmetros:
    /// - assembly: full qualified name do assembly do provedor.
    /// </remarks>
    public class ODPNetDriver : ReflexionBasedDriver {
        /// <summary>
        /// Construtor da classe.
        /// </summary>
        /// <param name="parameters">Parâmetros de configuração do driver.</param>
        public ODPNetDriver(Dictionary<string, string> parameters) {
            _parameters = parameters;

            #region Verificação de parâmetros

            string assembly = "Oracle.DataAccess, Version=2.111.7.0, Culture=neutral, PublicKeyToken=89b483f429c47342";
